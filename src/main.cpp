...
#define crab_cue01(a3, a4, a5) \
    spawn_crab_cue01(reinterpret_cast<s64*>(a1)[7280], a2, a3, a4, a5)
...
#define insect_cue00(ticks, alsoTicks, a5) \
    spawn_insect_cue00(reinterpret_cast<s64*>(a1)[7304], a2, ticks, alsoTicks, a5)
